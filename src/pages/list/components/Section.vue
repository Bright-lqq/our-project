    ...
    <div class = "list-box">
        <div class="list-filter">
            <div class="list-select" >
                <span class="list-select-caption" :class = "{caption:active}" @click = "handleClickDown()">
                    {{allSale}}
                    ...
                    <div class = "list-submenu-left"  >
                        <ul class = "list-submenu-all" v-if = "isShow">
                            <li class = "list-submenu-classification" v-for = "item in menuleftInfo" :key = "item.id" @click = "handleClassifyClick(item)">
                                ...
                                <span class = "list-submenu-num">
                                    {{item.subnum}}
                                </span>
                                <ul class = "list-submenu-scenicspot" >
                                    <li class = "list-submenu-item" v-for = "menu in showlist" :key = "menu.id" >
                                        {{menu.title}}
                                        <span class = "list-submenu-num">
                                            {{menu.num}}
                                        </span>
            ...
            <div class="list-select">
                <span class="list-select-caption" :class = "{caption:Activity}" @click = "handleClickPulldown()">
                    {{allrecommend}}
                    <i :class = "{'triangle_border_down':!Activity,'triangle_border_up':Activity}"></i>
                </span>
                <ul class = "list-select-caption-center" v-if = "Out" >
                    <li class = "list-select-caption-title">
                        {{recommendA}}
                    </li>
                    <li class = "list-select-caption-title">
                        {{recommendB}}
                ...
                <li class = "list-ticketCon-group" v-for = "list in listInfo" :key = "list.id">
                    <div class = "list-ticketCon-info">
                        ...
                        <div class="list-ticketCon-detail">
                            <h3 class="list-ticketCon-name">
                                {{list.name}}
                            </h3>
                            <span class="list-ticketCon-word">
                                {{list.hot}}
                            </span>
                            <span class="list-ticketCon-price">
                                ¥
                                <em>{{list.price}}</em>
                                <span class="list-ticketCon-text">
                                    &nbsp;起
                                </span>
                            </span>
                            <div class="list-ticketCon-comments">
                                <span class="iconfont icon-wuxing"></span>
                                <span class="list-ticketCon-totalnum">
                                    {{list.totalnum}}
                                </span>
                            </div>
                            <div class="list-ticketCon-location">
                                <span class="list-ticketCon-address">
                                    {{list.address}}
                                </span>
                            </div>
                        </div>
