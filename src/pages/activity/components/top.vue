<template>
    <div class="gotop" id="gotop" @click="handleClick" >
        <div class="gotop-inner">
            <span class="gotop-arrow"></span>
        </div>
    </div>
</template>
<script>
 export default {
    ...
    mounted() {
        ...
        window.onscroll = function(e){
            ...
            // console.log(that.y); 
            // console.log(parseInt(document.defaultView.getComputedStyle(document.body, null)['height']));
...
.gotop {
    ...
    transition: 400ms;
    transform: translate(0px, -1rem) translateZ(0px);
}
.gotop-inner {
    position: absolute;
    top: 50%;
